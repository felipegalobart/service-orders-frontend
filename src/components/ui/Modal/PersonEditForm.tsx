...
export const PersonEditForm: React.FC<PersonEditFormProps> = ({
    ...
    const removeContact = (index: number) => {
        setFormData(prev => {
            const wasRemovingDefault = prev.contacts[index]?.isDefault;
                        ...
                        <div key={index} className="bg-gray-800 rounded-lg p-4 border border-gray-600">
                            ...
                            <div className="mt-4 flex gap-6">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <label htmlFor={`whatsapp-edit-${index}`} className="ml-3 text-sm font-medium text-gray-300 cursor-pointer hover:text-green-400 transition-colors flex items-center">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <label htmlFor={`default-edit-${index}`} className="ml-3 text-sm font-medium text-gray-300 cursor-pointer hover:text-blue-400 transition-colors">
                                        ⭐ Contato Padrão
                                    </label>
                                </div>
                            </div>
