    ...
    return (
        <>
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {/* 2. Grid 2 Colunas: Equipamento e Informações do Serviço */}
                ...
                {/* 4. Grid 3 Colunas: Financeiro, Notas Fiscais e Observações */}
