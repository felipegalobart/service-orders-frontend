...
interface ServiceOrderPrintNoHeaderProps {
    order: ServiceOrder;
    onBack?: () => void;
}

export const ServiceOrderPrintNoHeader: React.FC<ServiceOrderPrintNoHeaderProps> = ({ order, onBack }) => {
    ...
    return (
        <>
            ...
            <div className="bg-white text-black p-4 max-w-4xl mx-auto text-xs line-height-1 eco-font-test">
                ...
                {/* Linha de recorte - com margin-top para ocupar o espaço do cabeçalho removido */}
                <div className="mt-3 border-t border-dashed border-gray-600 text-center print-top-margin">
                </div>
        ...
        @media print {
          ...
          *, div, span, p, h1, h2, h3, th, td {
          ...
          /* Margin-top especial para empurrar conteúdo para baixo */
          .print-top-margin {
