...
import { ServiceOrderPrintNoHeader } from '../../../components/serviceOrders/ServiceOrderPrintNoHeader';
import { LoadingSpinner } from '../../../components/ui/Loading';

export const ServiceOrderPrintNoHeaderPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
            <ServiceOrderPrintNoHeader order={orderWithCustomer} onBack={handleClose} />
        </div>
    );
};
