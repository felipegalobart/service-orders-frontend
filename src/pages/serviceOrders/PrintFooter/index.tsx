...
import { ServiceOrderPrintFooter } from '../../../components/serviceOrders/ServiceOrderPrintFooter';
import { LoadingSpinner } from '../../../components/ui/Loading';

export const ServiceOrderPrintFooterPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
            <ServiceOrderPrintFooter order={orderWithCustomer} onBack={handleClose} />
        </div>
    );
};
