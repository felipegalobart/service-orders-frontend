// Export all Service Order pages
export { default as ServiceOrderList } from './List';
export { default as ServiceOrderCreate } from './Create';
export { default as ServiceOrderEdit } from './Edit';
